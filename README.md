...
Docker sofar
[](https://github.com/fraorma99/MLOps-Group-20/tree/Fran_V1#docker-sofar)
...
git push origin Fran_V1 these are the orders of my code but do i even need the first part or just the docker part
